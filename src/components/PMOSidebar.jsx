...
const pmoNavItems = [
  ...
  { icon: <FolderKanban size={22} />, label: "users", path: "/pmo/projects" },
  { icon: <Users size={22} />, label: "Organizations", path: "/pmo/team" },
  { icon: <TrendingUp size={22} />, label: "projects", path: "/pmo/analytics" },
  { icon: <FileText size={22} />, label: "Compliance", path: "/pmo/reports" },
];

const bottomItems = [
  { icon: <FileText size={20} />, label: "Documentation", path: "/pmo/docs" },
