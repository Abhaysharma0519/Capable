...
export default function AuditorCompliances() {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      title: "System",
      desc: "Auditor compliance frameworks loaded successfully",
      time: "Just now",
      type: "info",
    },
  ]);
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#F3F4F9] font-sans text-[#1F2937]">
      ...
      <main className="flex-1 px-4 py-24 md:px-10 md:py-8 lg:py-10 max-w-7xl mx-auto overflow-x-hidden">
        {/* HEADER */}
        <header className="flex justify-between items-center mb-8 pb-6 border-b border-[#6A5AFF]">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-8 pb-6 border-b border-gray-100">
            ...
            <p className="text-sm text-slate-500">
              View and monitor compliance frameworks assigned to your audit scope.
            </p>
          </div>
          ...
          <div className="p-8 border-b border-gray-100">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-[#F3F4F9] rounded-2xl focus:ring-2 focus:ring-[#6A5AFF] outline-none text-sm"
                value={searchQuery}
            ...
            <div className="space-y-1">
              {filteredCompliances.map((item) => (
                <motion.div
                  ...
                  onClick={() => navigate(`/auditor/compliance/${item.id}`)}
                >
