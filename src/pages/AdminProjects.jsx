...
export default function AdminProjects() {
  ...
  const [notifications] = useState([
    { id: 1, title: "System", desc: "Project backup completed", time: "2m ago" },
    { id: 2, title: "Update", desc: "New auditor assigned to Company-1", time: "1h ago" },
  ]);
  ...
  // FIX: Removed .replace("-", "") to match your data structure exactly
    ...
    <div className="flex min-h-screen w-full bg-[#F3F4F9] font-sans text-[#1F2937]">
      ...
      <main className="flex-1 px-4 py-8 md:px-10 max-w-7xl mx-auto overflow-x-hidden">
        <header className="flex justify-between items-center mb-8 pb-4 border-b border-[#6A5AFF]">
          ...
          <div className="flex gap-3 items-center">
            ...
            <div className="relative">
              ...
              {/* FIX: Added missing Notifications Dropdown UI */}
              <AnimatePresence>
                {showNotifications && (
                  <>
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500">Manage and oversee all the ongoing and completed compliance projects.</p>
        </div>
